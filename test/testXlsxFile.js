/*
 * testXlsxFile.js - test the xlsx file type handler object.
 *
...
module.exports.XlsxFile = {
    ...
    testXlsxFileParseSimpleGetByKey: function(test) {
        test.expect(5);
    ...
    testXlsxFileParseSimpleGetByKey2: function(test) {
        test.expect(3);
    ...
    testXlsxFileParseMultipleWithKey: function(test) {
        test.expect(6);
    ...
    testXlsxFileTest2: function(test) {
        test.expect(2);
